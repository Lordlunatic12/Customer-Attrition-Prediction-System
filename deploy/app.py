...
def main():
    ...
    st.markdown("""
     :dart:  This Streamlit app is made to predict customer churn in a telecommunication company.
    ...
    if add_selectbox == "Online":
        ...
        monthlycharges = st.slider('The amount charged to the customer monthly', min_value=0, max_value=150, value=0)
        totalcharges = st.slider('The total amount charged to the customer',min_value=0, max_value=10000, value=0)
